...
public class PlayerMovement : MonoBehaviour
{
    ...
    public void PlayerMove()
    {
        ...
        //Only handle click - and - move if in Move Mode
        if (modeManager.GetCurrentMode() == PlayerModeManager.PlayerMode.Move)
        {
            HandleClickAndMove();
        }
    }
    ...
    // function to handle all click-and-move logic
...
//        placeTile = FindObjectOfType<PlaceTile>();
//        modeManager = FindObjectOfType<PlayerModeManager>();
//        //Assert.IsNotNull(modeManager, "PlayerModeManager not found in the scene!");
//        targetPosition = transform.position; // Initialize target to current position
...
//                    return; // Prevent movement to EarthTerrain tiles
//                }
//                SetTargetAndMove(potentialTarget);
//                FindObjectOfType<BattleSystem>().PlayerActionTaken();
//            }
//            else
//            {
